...
def mostrar_vistas_negocio(neg_id, nom_u):
    ...
    with t2: st.subheader("📉 Gastos") # Pendiente lógica
    with t3: st.subheader("📜 Historial") # Pendiente lógica
    with t4: st.subheader("👥 Clientes") # Pendiente lógica
...
if not st.session_state.autenticado:
    ...
    # --- SIDEBAR (PANEL IZQUIERDO) CON ROL CLARO ---
    with st.sidebar:
